...
class NotesSlidePart extends OxmlPart {
  static _N = "NotesSlidePart";
  static _R = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/notesSlide";
  static _C = "application/vnd.openxmlformats-officedocument.presentationml.notesSlide+xml";
  static _P = "../notesSlides";
  static _T = "notesSlide";
  static _E = NotesSlide;
  get notesSlide() {
    return this._r;
  }
  set notesSlide(root) {
