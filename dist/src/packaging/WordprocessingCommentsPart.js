...
class WordprocessingCommentsPart extends OxmlPart {
  static _N = "WordprocessingCommentsPart";
  static _R = "http://schemas.openxmlformats.org/officeDocument/2006/relationships/comments";
  static _C = "application/vnd.openxmlformats-officedocument.wordprocessingml.comments+xml";
  static _P = ".";
  static _T = "comments";
  static _E = Comments;
  get comments() {
