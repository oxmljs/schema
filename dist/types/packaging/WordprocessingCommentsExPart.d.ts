...
export declare class WordprocessingCommentsExPart extends OxmlPart<CommentsEx> {
    static _N: string;
    static _R: string;
    static _C: string;
    static _P: string;
    static _T: string;
    static _E: typeof CommentsEx;
    get commentsExtended(): CommentsEx | undefined;
    set commentsExtended(root: CommentsEx | undefined);
