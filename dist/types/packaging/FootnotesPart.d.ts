...
export declare class FootnotesPart extends OxmlPart<Footnotes> {
    static _N: string;
    static _R: string;
    static _C: string;
    static _P: string;
    static _T: string;
    static _E: typeof Footnotes;
    get footnotes(): Footnotes | undefined;
    set footnotes(root: Footnotes | undefined);
