...
export declare class NotesMasterPart extends OxmlPart<NotesMaster> {
    static _N: string;
    static _R: string;
    static _C: string;
    static _P: string;
    static _T: string;
    static _E: typeof NotesMaster;
    get notesMaster(): NotesMaster | undefined;
    set notesMaster(root: NotesMaster | undefined);
