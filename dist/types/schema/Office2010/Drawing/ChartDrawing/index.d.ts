...
export declare class ContentPart extends OxmlCompositeElement<NonVisualContentPartProperties | ApplicationNonVisualDrawingProperties | Transform2D | OfficeArtExtensionList> {
    static _Q: string;
    static _A: string[];
...
export declare function initOffice2010DrawingChartDrawingNamespace(): {
    prefix: string;
    xmlns: string;
};
