...
export class MainDocumentPart extends OxmlPart<Document> {

    public static override _N = 'MainDocumentPart';
    public static override _R = 'http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument';
    public static override _C = 'application/vnd.openxmlformats-officedocument.wordprocessingml.document.main+xml';
    public static _P = 'word';
    public static _T = 'document';
    public static override _E = Document;

    public get document() { return this._r; }
    public set document(root: Document | undefined) { this._r = root; }

    public get customXmlParts() { return this._m<CustomXmlPart>('CustomXmlPart'); }
    public get glossaryDocumentPart() { return this._f<GlossaryDocumentPart>('GlossaryDocumentPart'); }
