...
export class FootnotesPart extends OxmlPart<Footnotes> {

    public static override _N = 'FootnotesPart';
    public static override _R = 'http://schemas.openxmlformats.org/officeDocument/2006/relationships/footnotes';
    public static override _C = 'application/vnd.openxmlformats-officedocument.wordprocessingml.footnotes+xml';
    public static _P = '.';
    public static _T = 'footnotes';
    public static override _E = Footnotes;

    public get footnotes() { return this._r; }
    public set footnotes(root: Footnotes | undefined) { this._r = root; }
