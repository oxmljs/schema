...
export class WordprocessingCommentsPart extends OxmlPart<Comments> {

    public static override _N = 'WordprocessingCommentsPart';
    public static override _R = 'http://schemas.openxmlformats.org/officeDocument/2006/relationships/comments';
    public static override _C = 'application/vnd.openxmlformats-officedocument.wordprocessingml.comments+xml';
    public static _P = '.';
