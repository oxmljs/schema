...
export class PresentationDocument extends OxmlPackage {
    ...
    public get presentationPart() { return this._f<PresentationPart>('PresentationPart'); }
    ...
    public addPresentationPart() { return this._a(PresentationPart); }
