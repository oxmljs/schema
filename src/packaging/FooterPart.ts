...
export class FooterPart extends OxmlPart<Footer> {

    public static override _N = 'FooterPart';
    public static override _R = 'http://schemas.openxmlformats.org/officeDocument/2006/relationships/footer';
    public static override _C = 'application/vnd.openxmlformats-officedocument.wordprocessingml.footer+xml';
    public static _P = '.';
    public static _T = 'footer';
    public static override _E = Footer;

    public get footer() { return this._r; }
    public set footer(root: Footer | undefined) { this._r = root; }
