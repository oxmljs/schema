...
export class SpreadsheetDocument extends OxmlPackage {
    ...
    public get workbookPart() { return this._f<WorkbookPart>('WorkbookPart'); }
    ...
    public addWorkbookPart() { return this._a(WorkbookPart); }
