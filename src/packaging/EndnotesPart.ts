...
export class EndnotesPart extends OxmlPart<Endnotes> {

    public static override _N = 'EndnotesPart';
    public static override _R = 'http://schemas.openxmlformats.org/officeDocument/2006/relationships/endnotes';
    public static override _C = 'application/vnd.openxmlformats-officedocument.wordprocessingml.endnotes+xml';
    public static _P = '.';
    public static _T = 'endnotes';
    public static override _E = Endnotes;

    public get endnotes() { return this._r; }
    public set endnotes(root: Endnotes | undefined) { this._r = root; }
