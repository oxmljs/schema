...
export class LockedCanvas extends OxmlCompositeElement<ANonVisualGroupShapeProperties | AVisualGroupShapeProperties | ATextShape | AShape | AConnectionShape | APicture | A14GvmlContentPart | AGraphicFrame | AGroupShape | AGvmlGroupShapeExtensionList> {

    public static override _Q = 'lc:lockedCanvas';
    /** Non-Visual Properties for a Group Shape. */
    public get nonVisualGroupShapeProperties(): ANonVisualGroupShapeProperties | undefined { return this._f(ANonVisualGroupShapeProperties); }
    /** Visual Group Shape Properties. */
    public get visualGroupShapeProperties(): AVisualGroupShapeProperties | undefined { return this._f(AVisualGroupShapeProperties); }

}

export function initDrawingLockedCanvasNamespace() {
    LockedCanvas._C = {
