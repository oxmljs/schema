...
export class OfficeArtExtensionList extends OxmlCompositeElement<AExtension> {
    ...
    public static override _Q = 'xdr14:extLst';
...
export class Transform2D extends OxmlCompositeElement<AOffset | AExtents> {
    ...
    public static override _Q = 'xdr14:xfrm';
...
export class ApplicationNonVisualDrawingProperties extends OxmlLeafElement {
    ...
    public static override _Q = 'xdr14:nvPr';
    ...
    public get publishedFlag(): BooleanValue | undefined { return this._g(':fPublished'); }
    public set publishedFlag(v: BooleanValue | undefined) { this._s(':fPublished', v); }

}
/** Defines the ExcelNonVisualContentPartShapeProperties Class. Serialized as `xdr14:nvContentPartPr` */
export class ExcelNonVisualContentPartShapeProperties extends OxmlCompositeElement<NonVisualDrawingProperties | NonVisualInkContentPartProperties> {

    public static override _Q = 'xdr14:nvContentPartPr';
...
export class NonVisualInkContentPartProperties extends OxmlCompositeElement<A14ContentPartLocks | A14OfficeArtExtensionList> {
    ...
    public static override _Q = 'xdr14:cNvContentPartPr';
...
export class NonVisualDrawingProperties extends OxmlCompositeElement<AHyperlinkOnClick | AHyperlinkOnHover | ANonVisualDrawingPropertiesExtensionList> {
    ...
    public static override _Q = 'xdr14:cNvPr';
...
export class ContentPart extends OxmlCompositeElement<ExcelNonVisualContentPartShapeProperties | ApplicationNonVisualDrawingProperties | Transform2D | OfficeArtExtensionList> {

    public static override _Q = 'xdr14:contentPart';
    ...
    public get excelNonVisualContentPartShapeProperties(): ExcelNonVisualContentPartShapeProperties | undefined { return this._f(ExcelNonVisualContentPartShapeProperties); }
...
export function initOffice2010ExcelDrawingNamespace() {
